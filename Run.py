...
def main():
    ...
    Main.correctImage(get_path='Colour_Check/original_image.jpg',
                      return_type='save',
                      save_path ='Colour_Check/Protanopia_corrected.png',
    ...
    Main.correctImage(get_path='Colour_Check/original_image.jpg',
                      return_type='save',
                      save_path='Colour_Check/Deutranopia_corrected.png',
  ...
  #Colour correcting image for Hybrid with diagnosed degree of 1.0 for both Protanopia and Deutranopia and saving the image.
    Main.correctImage(get_path='Colour_Check/original_image.jpg',
                      return_type='save',
                      save_path='Colour_Check/Hybrid_corrected.png',
